...
var app      = express();
var port     = process.env.PORT || 2021; // whatever environment settings the client has set up will be priortized, it will run on our set port.
...
//   // require('./routes')(app, passport, db) // MOVE?
